...
Status: `LESSONS_1_2_3_STORYBOARD_MAPPED — LESSON_4_PENDING`
...
|---|---|---:|---:|---|---|---|
| C11-001 | Chapter framing + learning outcomes | 108 | 113 | L1-L4 distributed | MAPPED | L1-S01–L1-S03 opening foundation; L2-S14 synthesis; L3-S13 synthesis; L4 pending |
...
| C11-017 | Chapter summary / new terms | 116–117 | 121–122 | L1-L4 | MAPPED_AS_RETRIEVAL_SUMMARY | L1-S13/L1-S14; L2-S14; L3-S13; L4 pending |
...
| C11-020 | Short-answer questions | 118 | 123 | L1-L4 | MAPPED_PRACTICE/HOMEWORK | L1-S14; L2-S14; L3-S13; L4 pending |
...
| B11-016 | Real/virtual; erect/inverted; magnified/reduced image vocabulary | L3 | prerequisite | VERIFIED | L3-S04, L3-S05, L3-S06 |
| B11-017 | Cornea provides most initial eye focusing; lens fine-tunes | L3/L4 | scientific clarification | VERIFIED_CLARIFICATION | L3-S07, L3-S09, L3-S10, L3-S13; L4 pending |
| B11-018 | Eye focusing/accommodation | L3 | bridge | VERIFIED | L3-S10 |
...
| B11-020 | Eye-camera focusing: similar function, different mechanism | L4 | analogy guardrail | VERIFIED_CLARIFICATION | TBD |
...
- `SI-11-006` cornea/lens focusing roles → L3-S07/L3-S09/L3-S10/L3-S13 and L4, C11-013/B11-017
...
As each storyboard stabilizes, replace remaining `TBD` entries with concrete lesson/slide identifiers. When any source statement changes in a later textbook edition, use this matrix to identify the exact impacted lesson/slide records before editing decks.
