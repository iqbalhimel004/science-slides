...
## Textbook body versus supplementary bridge

### Textbook body

- refraction of light
- qualitative refraction rules and ray terminology
- everyday refraction applications
...
6. straight-line propagation in a homogeneous transparent medium
7. interface/boundary, normal and measuring angles from the normal
8. reflection-versus-refraction distinction
9. qualitative relation between medium change, propagation speed and refraction
...
Students leave Lesson 1 able to explain why and in which direction a ray changes direction. This knowledge is prerequisite for apparent depth, critical angle and TIR.
...
Camera explanation becomes much easier after students already understand convex-lens image formation and the eye. The lesson then closes the chapter by comparing systems and integrating the full concept chain.
